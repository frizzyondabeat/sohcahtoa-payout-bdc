...
import PhoneNumberInput, * as RPNInput from 'react-phone-number-input';
...
>(({ className, ...props }, ref) => (
  <Input
    className={cn('h-12 rounded-s-none rounded-e-lg', className)}
    {...props}
    ref={ref}
  />
));
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="flex h-12 gap-1 rounded-s-lg rounded-e-none border-r-0 px-3 focus:z-10"
          disabled={disabled}
        >
          <FlagComponent
